...
sysconfig.sh --help
====================
-h | --help: provide the arguments available
--cpu:       provide cpu information
--disk:      provide disk information
--domain:    provide domain information
--host:      provide the host information
--ipconfig:  provide ip information
--os:        provide Operating System information
--memory:    provide Memory information
--printer:   provide Printer information
"
}

# This function will remove all the temp files created by the script
function cleanup {
  rm /tmp/*.$$ && echo "cleaned temporary files by this script"
  exit
}
